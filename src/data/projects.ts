...
export const projects: Project[] = [
  ...
  },
  {
    ...
    tagline: "Nutrition tracking and diet planning.",
    description:
      "A diet and nutrition companion built for people following a structured plan — daily tracking, plan adherence and progress over time. Published to both the App Store and Google Play during its run; the listings have since been retired by the client.",
    role: "Flutter Developer",
    stack: ["Flutter", "Dart", "State Management", "REST APIs", "Local Storage", "Notifications"],
    links: {},
    icon: null,
    featured: true,
